...
import com.cooksys.ftd.springboot.Entities.*;
...
public class TweetController {
	...
	public Tweet replyToTweetById(@PathVariable("id") Integer id, @RequestBody ContentCredentialsDto contentCredentialsDto) {
